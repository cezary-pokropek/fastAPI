...
class Book(BaseModel):
    ...
    class Config:
        schema_extra = {
           "example":{
               "id": "b9d1ae18-a96a-4100-8b2f-14d0036c2ab4",
               "title": "Computer Science Pro",
               "author": "Codingwithyourmom",
...
def create_books_no_api():
    book_1 = Book(id="c9d1ae18-a96a-4100-8b2f-14d0036c2ab4",
                  title="Title 1",
                  author="Author 1",
                  description="Description 1",
                  rating=60)
    book_2 = Book(id="0417763d-04f5-4ae9-b935-fb9bb54f38a3",
                  title="Title 2",
                  author="Author 2",
                  description="Description 2",
                  rating=70)
    book_3 = Book(id="b8588c8a-051b-4e7c-9638-87520b9b5a96",
                  title="Title 3",
                  author="Author 3",
                  description="Description 3",
                  rating=80)
    book_4 = Book(id="95386b97-6b8f-4ee1-a2cb-0cc7be860fd3",
                  title="Title 4",
                  author="Author 4",
                  description="Description 1",
                  rating=90)
